...
const AboutMe = () => {
  return (
    <div className='flex p-5  justify-center flex-row'>
        <div className='bg-slate-950 sm:w-[620px] shadow-lg border-blue-500 border-x-2 shadow-blue-500/25  lg:w-[700px] p-8 rounded-lg w-65'>
        <h1 className='md:text-4xl text-2xl text-center  mb-5 font-bold'>More About Me</h1>
